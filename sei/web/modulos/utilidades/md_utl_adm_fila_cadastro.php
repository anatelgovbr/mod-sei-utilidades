    ...
    <fieldset style="width: 86%;" class="infraFieldset">
      ...
      <div id="divUsuarioParticipante">
        <label id="lblUsuarioParticipante" for="selUsuarioParticipante" accesskey="" class="infraLabelObrigatorio">Usuários
          Participantes:</label>
        <a style="" id="btAjudaUsuarioParticipante" <?= PaginaSEI::montarTitleTooltip('Independente da distribuição automática, o Gestor do Controle pode distribuir diretamente ou o membro que participa do Controle pode assumir diretamente qualquer processo pendente de distribuição.') ?>
           tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
      ...
      <div class="divPapeis" id="divPapeis">
        ...
        <!-- Triador -->
        <div>
          <input onchange="controlarVisualizacaoPercentual();" type="checkbox" name="rdoTriador" id="rdoTriador" class="infraCheckbox"/>
        ...
        <!-- Analista -->
        <div style="margin-top: 8px">
          <input onchange="controlarVisualizacaoPercentual();" type="checkbox" name="rdoAnalista" id="rdoAnalista" class="infraCheckbox"/>
        ...
        <!-- Revisor -->
        <div style="margin-top: 8px">
          <input type="checkbox" name="rdoRevisor" id="rdoRevisor" class="infraCheckbox"/>
      ...
      <!-- Percentual de Revisão do Analista -->
      <div id="divPercentualRevisao">
        <label id="lblPercentualRevisao" name="lblPercentualRevisao" for="txtPercentualRevisao" class="infraLabelOpcional">Percentual de Revisão:</label>
        <input style="width: 33px" utlSomenteNumeroPaste="true" disabled="disabled" type="text" name="'" maxlength="11"  onchange="return validarValorPercentual(this);" onkeypress="return infraMascaraNumero(this,event,3);" id="txtPercentualRevisao" class="infraText" value="0"/>
        <a style="" id="btAjudaPercRevisao" <?=PaginaSEI::montarTitleTooltip('O valor indica o percentual a ser aplicado na redução da carga padrao diária, a ser distribuído no período informado. Infome o valor  maior que  0 e  menor que 100.')?>
           tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>">
      ...
      <div id="divTabelaUsuarioParticipante" style="<?php echo $strGridUsuariosParticipantes == '' ? 'display: none' : ''?>">
        ...
        <table width="99%" class="infraTable" summary="Usuário Participante" id="tbUsuarioParticipante">
          ...
          <tr>
            ...
            <th class="infraTh" align="center" width="15%">% Revisão </th>
