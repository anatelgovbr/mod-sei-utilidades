<script type="text/javascript">
    ...
    function desmarcarCkbDistAutoParaMim(){
        let divDistAutoParaMim = $('#divDistAutoParaMim');
        let ckbDistAut         = $('#ckbDistAutoParaMim');

        divDistAutoParaMim.hide();    
        ckbDistAut.prop('checked',false);    
    }

    function desmarcarCkbDistAutoTriagem(){
        let divDistAutoTriagem = $('#divDistAutoTriagAnalise');
        let ckbDistAut         = $('#ckbDistAutoTriagAnalise');

        divDistAutoTriagem.hide();    
        ckbDistAut.prop('checked',false);    
    }
