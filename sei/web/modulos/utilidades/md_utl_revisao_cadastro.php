...
$habDivDistAutoTriagem = ( $encaminhamentoRevisao['sta_encaminhamento'] == 'N' && $validaDistAutoTriagem ) ? true : false;
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-check form-check-inline mb-0">
                    <?php $attrs = 'onchange="realizarAvaliacaoProd( this ) "' .  $disabled . $ckbRealizarAvalProdProd; ?>
                    <!-- O ->getTrCheck() adiciona o prefixo [chkItem] no id e nome do campo -->
                    <?= PaginaSEI::getInstance()->getTrCheck('cbkRealizarAvalProdAProd', 'S', 'cbkRealizarAvalProdAProd', null, null, $attrs); ?>
                    <label for="chkItemcbkRealizarAvalProdAProd" class="form-check-label infraLabelOpcional pt-1" tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
