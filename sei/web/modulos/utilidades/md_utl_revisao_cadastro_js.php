<script type="text/javascript">
    ...
    function inicializar(){
       ...
       //a fila vinculado ao processo
       <?php if ( $isEdicao ): ?>
            if( $('#chkDistAutoTriagem').val() == 'S' && $('#validaDistAutoTriagem').val() == 'err' ){
                alert("<?= MdUtlMensagemINT::$MSG_UTL_124 ?>");
                $('#ckbDistAutoTriagAnalise').prop('checked',false);
                $('#divDistAutoTriagAnalise').hide(); 
            }
        <?php endif; ?>
    }
