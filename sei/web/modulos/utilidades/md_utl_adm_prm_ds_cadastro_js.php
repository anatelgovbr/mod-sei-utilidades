...
if (0){
    ...
    function validarCadastro() {
        ...
        if(selDiasUteis) {
            ...
            if (selPrioridadeDiasUteis.value === 'null') {
                var msg = setMensagemPersonalizada(msg13, ['valor em Prioridade geral para Dias ùteis no Status']);
                alert(msg);
            ...
            if (qtdDiasUteis.value === "") {
                var msg = setMensagemPersonalizada(msg13, ['valor em Quantidade Dias Úteis']);
                alert(msg);
    ...
    function carregarComponenteTipoProcesso() {
        ...
        objAutoCompletarTipoProcesso.processarResultado = function (id, descricao, complemento) {
            ...
            if (id != '') {
                ...
                for (var i = 0; i < options.length; i++) {
                    if (options[i].value == id) {
                        var msg = setMensagemPersonalizada(msgPadrao10, ['Tipo Processo']); //Tipo de Processo já consta na lista
                        alert(msg);
                        break;
                    }
                }
    ...
    function validarPrioridadeGeral() { //não chama
        var msg = 'Fila';
        var valores = [];
