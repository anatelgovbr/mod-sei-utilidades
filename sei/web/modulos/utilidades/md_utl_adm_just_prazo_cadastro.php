...
PaginaSEI::getInstance()->abrirAreaDados('9em');
?>
  <label id="lblTipoSolicitacao" for="txtTipoSolicitacao" accesskey="" class="infraLabelObrigatorio">Tipo de Solicitação:</label>
  <a href="javascript:void(0);" id="ancAjudaTipoSolicitacao" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" <?=PaginaSEI::montarTitleTooltip('Opção que define o Tipo de Solicitação de Ajuste de Prazo.')?>><img class="tamanhoBtnAjuda" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/ajuda.gif" class="infraImg"/></a>
  ...
  <div id="divTipoSolicitacao" class="bloco">
    <div id="divDilacao">
      ...
      <label style="position:absolute;margin-top: 1px;" class="infraLabelChec infraLabelOpcional" for="rdoDilacao" id="lblDilacao">Dilação</label>
    </div>
    <div id="divSuspensao" class="campSuspensao">
      ...
      <label style="position:absolute;margin-top: 1px;" class="infraLabelCheckbox infraLabelOpcional" for="rdoSuspensao" id="lblSuspensao">Suspensão</label>
    </div>
    <div id="divInterrupcao" class="campInterrupcao">
      ...
      <label style="position:absolute;margin-top: 1px;" class="infraLabelCheckbox infraLabelOpcional" for="rdoInterrupcao" id="lblInterrupcao">Interrupção</label>
    </div>
  </div>
