...
class UtilidadesIntegracao extends SeiIntegracao
{
    ...
    public function excluirDocumento(DocumentoAPI $objDocumentoAPI)
    {
        ...
        $objMdUtlRelAnlProdutoDTO->retTodos();
        $objMdUtlRelAnlProdutoDTO->setStrSinVerificarPermissao('N');

        $count = $objMdUtlRelAnlProdutoRN->contar($objMdUtlRelAnlProdutoDTO) > 0;
