...
if($numRegistro > 0) {
    ...
    if( true ){
        ...
        $strResultado .= '<table class="infraTable" summary="Revisao" id="tb_avaliacao">';
        $strResultado .= '<caption class="infraCaption">';
        $strResultado .= PaginaSEI::getInstance()->gerarCaptionTabela('Atividades e Produtos Entregues', $numRegistro);
        $strResultado .= '</caption>';
        //Cabeçalho da Tabela
        $strResultado .= '<tr>';
        $strResultado .= '<th class="infraTh" width="10%" style="display: none">Id_Analise</th>';
        $strResultado .= '<th class="infraTh" width="20%">Atividade</th>';
        $strResultado .= '<th class="infraTh" width="12%">Produto</th>';
        #$strResultado .= '<th class="infraTh" width="8%">Documento</th>';
        $strResultado .= '<th class="infraTh" width="20%" style="text-align: left;">Observação sobre a Análise</th>';
        ...
        $strResultado .= '<th class="infraTh" width="20%" style="'.$exibirCol.'">Observação sobre a Avaliação</th>';
        $strResultado .= '</tr>';
