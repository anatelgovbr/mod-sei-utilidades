...
class MdUtlMensagemINT extends InfraINT {
    ...
    public static $MSG_UTL_124 = 'Usuário não vinculado à Fila, com isso, o campo que sinaliza a Distribuição automática para o Novo Fluxo do processo foi desmarcado.';
